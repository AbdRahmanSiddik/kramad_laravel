...
@section('content')
  <div class="page-content">
    <form class="form-horizontal" enctype="multipart/form-data" action="/tambah_team" method="POST">
      @csrf
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <textarea type="number" name="about" id="about" class="form-control @error('about') is-invalid @enderror">{{ old('about') }}</textarea>
                  @error('about')
                    <span class="label label-block label-danger">{{ $message }}</span>
                  @enderror
                </div>
