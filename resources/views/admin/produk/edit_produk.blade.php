@php
    $title = "K'ramad Edit | ".$produk->name;
@endphp
...
<div class="page-content">
    <form class="form-horizontal" enctype="multipart/form-data" action="/produk/{{ $produk->token_coffee }}/edit" method="POST">
      @csrf
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $produk->name }}">
                  @error('name')
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ $produk->price }}">
                  @error('price')
                    <span class="label label-block label-danger">{{ $message }}</span>
                  @enderror
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="number" name="stock" id="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ $produk->stock }}">
                  @error('stock')
                    <span class="label label-block label-danger">{{ $message }}</span>
                  @enderror
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="number" name="netto" id="netto" class="form-control @error('netto') is-invalid @enderror" value="{{ $produk->netto }}">
                  @error('netto')
                    <span class="label label-block label-danger">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <label for="input-file" id="drop-area">
                    ...
                    <div id="image-view">
                      <img src="{{ asset('coffee/'.$produk->picture) }}" width="90px">
                    </div>
                  </label>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <textarea name="ingredients" id="ingredients" class="form-control @error('ingredients') is-invalid @enderror" style="height: 10.5rem;">{{ $produk->ingredients }}</textarea>
                  @error('ingredients')
                    <span class="label label-block label-danger">{{ $message }}</span>
                  @enderror
                </div>
