...
@section('content')
	...
	<div class="hero parallaxie">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						<h3 class="wow fadeInUp" data-wow-delay="0.50s">Welcome to K'ramad</h3>
					...
					<div class="hero-footer">
						...
						<a href="#" class="btn-default btn-order-online wow fadeInUp" data-wow-delay="1.25s">Order Online</a>
					</div>
					<!-- Hero Footer end -->
				</div>
			</div>
		...
		<div class="down-arrow">
			<a href="#home-about"><img src="{{ asset('fwizz') }}/images/icon-down-arrow.svg" alt=""></a>
		</div>
	</div>
					...
					<div class="home-about-left">
						<div class="home-about-img">
							<figure class="reveal image-anime">
								<img src="{{ asset('fwizz') }}/images/about-us-1.jpg" alt="">
							</figure>

							<figure class="reveal image-anime">
								<img src="{{ asset('fwizz') }}/images/about-us-2.jpg" alt="">
							</figure>
						</div>
						...
						<div class="about-icon-box">
							<div class="icon-box wow fadeInUp" data-wow-delay="1.00s">
								<div class="icon-box-img">
									<img src="{{ asset('fwizz') }}/images/icon-about-1.svg" alt="">
								</div>
							...
							<div class="icon-box wow fadeInUp" data-wow-delay="1.25s">
								<div class="icon-box-img">
									<img src="{{ asset('fwizz') }}/images/icon-about-2.svg" alt=""></div>
								<div class="icon-box-content">
									<h3>24X7 Services</h3>
									<p>Duis nec semper ligula. Nullam nec.</p>
								</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-12">
					<div class="wcu-img-box wow fadeInUp" data-wow-delay="0.50s">
						...
						<div class="image-box">
							<figure>
								<img src="{{ asset('fwizz') }}/images/icon-why-choose-us-1.svg" alt="">
							</figure>
						</div>
						<!-- Image Box end -->
				...
				<div class="col-md-4 col-12">
					<div class="wcu-img-box wow fadeInUp" data-wow-delay="0.75s">
						...
						<div class="image-box">
							<figure>
								<img src="{{ asset('fwizz') }}/images/icon-why-choose-us-2.svg" alt="">
							</figure>
						</div>
						<!-- Image Box end -->
				...
				<div class="col-md-4 col-12">
					<div class="wcu-img-box wow fadeInUp" data-wow-delay="1.0s">
						...
						<div class="image-box">
							<figure>
								<img src="{{ asset('fwizz') }}/images/icon-why-choose-us-3.svg" alt="">
							</figure>
						</div>
						<!-- Image Box end -->
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-12">
					...
					<div class="menu-dises-nav wow fadeInLeft" data-wow-delay="0.75s">
						<ul>
							<li><a href="#" class="active-menu-dises" data-filter="*"><img src="{{ asset('fwizz') }}/images/icon-breakfast.svg" alt="">All Popular Dises</a></li>
							<li><a href="#" data-filter=".breakfast"><img src="{{ asset('fwizz') }}/images/icon-breakfast.svg" alt="">Breakfast</a></li>
							<li><a href="#" data-filter=".lunches"><img src="{{ asset('fwizz') }}/images/icon-lunches.svg" alt="">Lunches</a></li>
							<li><a href="#" data-filter=".dinner"><img src="{{ asset('fwizz') }}/images/icon-dinner.svg" alt="">Dinner</a></li>
							<li><a href="#" data-filter=".drinks"><img src="{{ asset('fwizz') }}/images/icon-drinks.svg" alt="">Drinks</a></li>
							<li><a href="#" data-filter=".fast-foods"><img src="{{ asset('fwizz') }}/images/icon-fast-foods.svg" alt="">Fast Foods</a></li>
							<li><a href="#" data-filter=".dessert"><img src="{{ asset('fwizz') }}/images/icon-dessert.svg" alt="">Dessert</a></li>
						</ul>
					</div>
					...
					<div class="row menu-item-boxes wow fadeInUp" data-wow-delay="1.00s">
							...
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-1.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
								...
								<div class="menu-item-body">
									<div class="rating-img">
										<img src="{{ asset('fwizz') }}/images/start-rating.png" alt="">
									</div>
						...
						<div class="col-lg-4 col-md-6 menu-item-box breakfast lunches">
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-2.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
						...
						<div class="col-lg-4 col-md-6 menu-item-box dinner fast-foods">
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-3.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
						...
						<div class="col-lg-4 col-md-6 menu-item-box dessert">
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-4.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
						...
						<div class="col-lg-4 col-md-6 menu-item-box drinks lunches dinner">
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-5.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
						...
						<div class="col-lg-4 col-md-6 menu-item-box dinner lunches">
							<div class="menu-item">
								...
								<div class="menu-item-img">
									<figure class="image-anime">
										<img src="{{ asset('fwizz') }}/images/menu-6.jpg" alt="">
									</figure>
								</div>
								<!-- Menu Item Image start -->
				...
				<div class="col-md-12">
					<div class="restaurant-info-box">
						<div class="info-box-content">
							...
							<p class="wow fadeInUp" data-wow-delay="0.75s">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
						...
						<div class="info-box-img">
							<img src="{{ asset('fwizz') }}/images/restaurants.png" alt="">
						</div>
						<!-- Info Box Img end -->
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-6">
					<div class="counter-bar wow fadeInUp" data-wow-delay="0.50s">
						<div class="counter-bar-img">
							<img src="{{ asset('fwizz') }}/images/info-bar-1.jpg" alt="">
						</div>
				...
				<div class="col-lg-3 col-6">
					<div class="counter-bar wow fadeInDown" data-wow-delay="0.75s">
						<div class="counter-bar-img">
							<img src="{{ asset('fwizz') }}/images/info-bar-2.jpg" alt="">
						</div>
						<div class="counter-bar-body">
				...
				<div class="col-lg-3 col-6">
					<div class="counter-bar wow fadeInUp" data-wow-delay="1.25s">
						<div class="counter-bar-img">
							<img src="{{ asset('fwizz') }}/images/info-bar-3.jpg" alt="">
						</div>
						<div class="counter-bar-body">
				...
				<div class="col-lg-3 col-6">
					<div class="counter-bar wow fadeInDown" data-wow-delay="1.50s">
						<div class="counter-bar-img">
							<img src="{{ asset('fwizz') }}/images/info-bar-4.jpg" alt="">
						</div>
						<div class="counter-bar-body">
			...
			<div class="row align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slide">
                                        <div class="testimonial-body">
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled mak a type specimen book.</p>
										</div>
				...
				<div class="col-lg-6 col-md-5">
					<div class="testimonial-img">
						<img src="{{ asset('fwizz') }}/images/testimonial-img.png" alt="">
					</div>
				</div>
				<!-- Testimonial Img end -->
			</div>
					...
					<div class="post-item wow fadeInUp" data-wow-delay="0.75s">
						...
						<div class="post-featured-image">
							<a href="blog-single.html">
								<figure class="image-anime">
									<img src="{{ asset('fwizz') }}/images/post-1.jpg" alt="">
								</figure>
							</a>
						</div>
						...
						<div class="post-header">
							<div class="post-meta">
								<ul>
									<li class="post-meta-date"><a href="blog-single.html">March 17, 2024</a></li>
									<li><a href="#">Restaurants</a></li>
								</ul>
							</div>
							<h3><a href="blog-single.html">Wine and Dine: Perfect Pairings for an Unforgettable Meal</a></h3>
						</div>
						<!-- Post Header End -->
					</div>
					<!-- Post Item End -->
				...
				<div class="col-lg-4 col-md-12">
					...
					<div class="post-item wow fadeInUp" data-wow-delay="1.0s">
						...
						<div class="post-featured-image">
							<a href="blog-single.html">
								<figure class="image-anime">
									<img src="{{ asset('fwizz') }}/images/post-2.jpg" alt="">
								</figure>
							</a>
						</div>
						<!-- Post Featured Image end -->
				...
				<div class="col-lg-4 col-md-12">
					...
					<div class="post-item wow fadeInUp" data-wow-delay="1.25s">
						...
						<div class="post-featured-image">
							<a href="blog-single.html">
								<figure class="image-anime">
									<img src="{{ asset('fwizz') }}/images/post-3.jpg" alt="">
								</figure>
							</a>
						</div>
						<!-- Post Featured Image end -->
						...
						<div class="post-header">
							...
							<h3><a href="blog-single.html">Tantalizing Tidbits: Fun Facts About Our Menu Creations</a></h3>
						</div>
						<!-- Post Header End -->
					</div>
					<!-- Post Item End -->
